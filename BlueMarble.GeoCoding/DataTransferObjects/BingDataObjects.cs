...
namespace BlueMarble.Geocoding.DataTransferObjects
{
	// These objects were acquired from the MSDN, and are current as of 4/30/2013.  You can
	// check for newwer versions here: http://msdn.microsoft.com/en-us/library/jj870778.aspx
